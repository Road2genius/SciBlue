...
export const ERROR_CODES = {
  ...
  // Comment vote
  COMMENT_VOTE_IS_REQUIRED: 1501,
  USER_CANNOT_VOTE_OWN_COMMENT: 1502,
};
...
export const ERROR_MESSAGES = {
  ...
  // Comment vote
  [ERROR_CODES.COMMENT_VOTE_IS_REQUIRED]: "Vote is required",
  [ERROR_CODES.USER_CANNOT_VOTE_OWN_COMMENT]: "User cannot vote to own request",
};
