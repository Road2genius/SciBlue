...
import { submitVoteComment, submitVoteRequest } from "../../controllers/request/voteController";
...
requestRouter.post(ENDPOINT.REQUEST_COMMENT_VOTE.SUBMIT_REQUEST_COMMENT_VOTE_PATH, authenticateJWT, submitVoteComment);
