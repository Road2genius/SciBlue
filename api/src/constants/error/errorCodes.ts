...
export const ERROR_CODES = {
  ...
  // Request Comment vote
  COMMENT_VOTE_IS_REQUIRED: 1501,
  USER_CANNOT_VOTE_OWN_COMMENT: 1502,

  // Question
  QUESTION_NOT_FOUND: 1601,
  QUESTIONS_NOT_FOUND: 1602,

  // Question comment
  QUESTION_COMMENT_EMPTY_TEXT: 1701,
  QUESTION_COMMENT_MISSING_USER_ID: 1702,
  QUESTION_COMMENT_NOT_FOUND: 1703,
  QUESTION_COMMENTS_NOT_FOUND: 1704,

  // Question vote
  QUESTION_VOTE_IS_REQUIRED: 1801,
  USER_CANNOT_VOTE_OWN_QUESTION: 1802,

  // Question Comment vote
  QUESTION_COMMENT_VOTE_IS_REQUIRED: 1901,
  USER_CANNOT_VOTE_OWN_QUESTION_COMMENT: 1902,
};
